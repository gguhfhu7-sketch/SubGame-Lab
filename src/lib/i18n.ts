...
export interface Translations {
  ...
  linesPerBatch: string;
  presetBatchSizes: string;
  customBatchSize: string;
  skipCodeOnly: string;
  skipCodeOnlyDesc: string;
  appendRTLMarkers: string;
  appendRTLMarkersDesc: string;
  rateLimitPacing: string;
  rateLimitPacingDesc: string;
  rateLimitPacingWarning: string;
  rateLimitPacingBadge: string;
  pacingWaitingDelay: string;
...
export const TRANSLATIONS: Record<UILanguage, Translations> = {
  fa: {
    ...
    appSubtitle: 'موتور هوشمند ترجمه زیرنویس',
    modeCinema: '🎬 زیرنویس فیلم و سریال',
    modeCinemaDesc: 'موتور سینمایی برای SRT, VTT, ASS با حفظ دقیق تایم‌کدها',
    modeGame: '🎮 بومی‌سازی و ترجمه بازی',
    modeGameDesc: 'بومی‌سازی هوشمند رشته‌های بازی',
    ...
    translatingProgress: 'در حال ترجمه با',
    pause: 'توقف موقت',
    resume: 'ادامه',
    cancel: 'لغو',
    ...
    batchSize: 'اندازه دسته‌های ارسالی (Batch Size)',
    batchSizeDesc: 'تعداد سطرهای ارسالی در هر درخواست (قابل تنظیم دستی و مستقل از مدل)',
    customBatchInput: 'تعداد سطرهای هر بسته',
    linesPerBatch: 'سطر در هر درخواست',
    presetBatchSizes: 'اندازه‌های سریع',
    customBatchSize: 'سفارشی',
    ...
    rateLimitPacing: 'کنترل نرخ درخواست و ضد محدودیت (Anti-Rate-Limit)',
    rateLimitPacingDesc: 'ایجاد فاصله زمانی خودکار میان ارسال بسته‌ها جهت پیشگیری از پر شدن سقف مجاز در دقیقه (RPM/TPM)',
    rateLimitPacingWarning: '⚠️ توجه: فعال بودن این گزینه سرعت کلی فرایند ترجمه را کند می‌کند، اما باعث می‌شود به لیمیت سقف درخواست در دقیقه (Rate Limit) نخورید.',
    rateLimitPacingBadge: 'ضد لیمیت RPM فعال',
    pacingWaitingDelay: 'مدیریت سقف درخواست: {seconds} ثانیه توقف برای حفظ پایداری...',
    advancedSettingsTitle: 'تنظیمات پیشرفته، بهینه‌سازی و سقف درخواست',
  ...
  en: {
    appTitle: 'SubGame Lab',
    appSubtitle: 'Smart Subtitle Translation Engine',
    modeCinema: '🎬 Movies & TV Subtitles',
    modeCinemaDesc: 'Cinema Engine for SRT, VTT, ASS with timecode preservation',
    modeGame: '🎮 Game Localization',
    modeGameDesc: 'Game Localization & String Engine',
    ...
    translatingProgress: 'Translating with',
    pause: 'Pause',
    resume: 'Resume',
    cancel: 'Cancel',
    ...
    batchSizeDesc: 'Number of rows sent per Gemini API call (user-configurable, independent of model)',
    customBatchInput: 'Custom rows per batch',
    linesPerBatch: 'lines / request',
    presetBatchSizes: 'Quick Presets',
    customBatchSize: 'Custom',
    ...
    rateLimitPacing: 'Anti-Rate-Limit & Request Pacing Protection',
    rateLimitPacingDesc: 'Adds intentional delays between batches to prevent exceeding per-minute API quotas (RPM/TPM)',
    rateLimitPacingWarning: '⚠️ Warning: Enabling this slows down overall translation speed, but prevents hitting per-minute API rate limits (Rate Limit).',
    rateLimitPacingBadge: 'RPM Shield Active',
    pacingWaitingDelay: 'Rate Limit Pacing: {seconds}s cooldown before next batch...',
    advancedSettingsTitle: 'Advanced Settings & Rate Limit Controls',
  ...
  ar: {
    appTitle: 'SubGame Lab',
    appSubtitle: 'محرك ذكي لترجمة زیرنویس',
    modeCinema: '🎬 ترجمة الأفلام والمسلسلات',
    modeCinemaDesc: 'محرك سينمائي لصيغ SRT, VTT, ASS مع الحفاظ على التوقيت الزمني',
    modeGame: '🎮 تعريب وترجمة الألعاب',
    modeGameDesc: 'تعريب ذكي لنصوص وبيانات الألعاب',
    ...
    translatingProgress: 'جاري الترجمة بواسطة',
    pause: 'إيقاف مؤقت',
    resume: 'استئناف',
    cancel: 'إلغاء',
    ...
    batchSizeDesc: 'عدد الأسطر المرسلة في كل طلب (قابل للتعديل يدويًا ومستقل عن النموذج)',
    customBatchInput: 'عدد الأسطر المخصص لكل حزمة',
    linesPerBatch: 'سطر لكل طلب',
    presetBatchSizes: 'أحجام سريعة',
    customBatchSize: 'مخصص',
    ...
    rateLimitPacing: 'التحكم في معدل الطلبات ومكافحة حظر الحصة (Anti-Rate-Limit)',
    rateLimitPacingDesc: 'إضافة فواصل زمنية تلقائية بين الدفعات لتجنب الوصول إلى سقف الطلبات في الدقيقة (RPM/TPM)',
    rateLimitPacingWarning: '⚠️ تنبيه: تفعيل هذا الخيار سيجعل عملية الترجمة أبطأ، ولكنه يضمن عدم تجاوز الحد الأقصى للطلبات في الدقيقة (Rate Limit).',
    rateLimitPacingBadge: 'حماية RPM مفعلة',
    pacingWaitingDelay: 'تنظيم معدل الطلبات: توقف {seconds} ثوانٍ للحفاظ على استقرار الحصة...',
    advancedSettingsTitle: 'الإعدادات المتقدمة وإدارة سقف الطلبات',
